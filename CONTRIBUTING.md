...
2. **Clone the Repository**: Clone the forked repository to your local development environment.
   ...
   ```bash
   git clone https://github.com/Unicamp-Odhin/GPIO_Peripheral.git
   ```
...
By contributing to this project, you agree that your contributions will be licensed under the same license as the project. Read the [license](https://github.com/Unicamp-Odhin/GPIO_Peripheral/blob/main/LICENSE) for more details.